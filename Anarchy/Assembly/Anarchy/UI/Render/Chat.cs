...
namespace Anarchy.UI
{
    internal class Chat : GUIBase
    {
        ...
        { "/sptit type size health speed count chaseDistance attackWait X Y Z [Optional ->] Faker[0|1] RockThrow[0|1] bodySkinLink eyeSkinLink animationSpeed ", "Spawn Custom Titan (1 = Enable)" },
