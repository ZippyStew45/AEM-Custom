...
internal partial class FengGameManagerMKII
{
    ...
    public void SPTitan(int type, float size, int health, float speed, int count, int chaseDistance, int attackWait, float posX, float posY, float posZ, bool lockAxis, bool RockThrow = false, string bodySkinLink = "", string eyeSkinLink = "", float animationSpeed = 1f)
    {
