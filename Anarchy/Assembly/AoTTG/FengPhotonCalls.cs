...
internal partial class FengGameManagerMKII
{
    ...
    public void OnPhotonPlayerDisconnected(AOTEventArgs args)
    {
        ...
        if (player != null)
        {
            if (player.RCIgnored)
            {
                Log.AddLine("playerKicked", MsgType.Info, player.ID.ToString(), player.UIName.ToHTMLFormat() + "|" + player.Kills.ToString() + "|" + player.Deaths.ToString() + "|" + player.MaximumDamage.ToString() + "|" + player.TotalDamage.ToString());
            }
            else
            {
                Log.AddLine("playerLeft", MsgType.Info, player.ID.ToString(), player.UIName.ToHTMLFormat() + "|" + player.Kills.ToString() + "|" + player.Deaths.ToString() + "|" + player.MaximumDamage.ToString() + "|" + player.TotalDamage.ToString());
            }
        }
