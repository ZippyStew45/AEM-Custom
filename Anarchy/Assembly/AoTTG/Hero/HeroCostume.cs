...
public class HeroCostume
{
    ...
    public static void Init()
    {
        ...
        body_casual_fb_texture = new string[]
        {
    ...
    public void setMesh()
    {
        ...
        bool flag = this.uniform_type == UNIFORM_TYPE.CasualAHSS;
        if (flag)
        {
            ...
            bool flag2 = this.sex == Sex.Female;
            if (flag2)
            {
        ...
        {
            bool flag3 = this.uniform_type == UNIFORM_TYPE.UniformA;
            if (flag3)
            {
                ...
                bool flag4 = this.sex == Sex.Female;
                if (flag4)
                {
            ...
            {
                bool flag5 = this.uniform_type == UNIFORM_TYPE.UniformB;
                if (flag5)
                {
                    this.arm_l_mesh = "character_arm_uniform_l";
                    this.arm_r_mesh = "character_arm_uniform_r";
                    this.brand1_mesh = "character_brand_arm_l";
                    this.brand2_mesh = "character_brand_arm_r";
                    bool flag6 = this.sex == Sex.Female;
                    if (flag6)
                    {
                ...
                {
                    bool flag7 = this.uniform_type == UNIFORM_TYPE.CasualA;
                    if (flag7)
                    {
                        this.arm_l_mesh = "character_arm_casual_l";
                        this.arm_r_mesh = "character_arm_casual_r";
                        bool flag8 = this.sex == Sex.Female;
                        if (flag8)
                        {
                            this.body_mesh = "character_body_casual_FA";
                        }
                    ...
                    {
                        bool flag9 = this.uniform_type == UNIFORM_TYPE.CasualB;
                        if (flag9)
                        {
                            this.arm_l_mesh = "character_arm_casual_l";
                            this.arm_r_mesh = "character_arm_casual_r";
                            bool flag10 = this.sex == Sex.Female;
                            if (flag10)
                            {
        ...
        bool flag11 = this.hairInfo.hair.Length > 0;
        if (flag11)
        {
            this.hair_mesh = this.hairInfo.hair;
        }
        bool hasCloth = this.hairInfo.hasCloth;
        if (hasCloth)
        {
            this.hair_1_mesh = this.hairInfo.hair_1;
        }
        bool flag12 = this.eye_texture_id >= 0;
        if (flag12)
        {
            this.eye_mesh = "character_eye";
        }
        bool flag13 = this.beard_texture_id >= 0;
        if (flag13)
        {
        ...
        bool flag14 = this.glass_texture_id >= 0;
        if (flag14)
        {
